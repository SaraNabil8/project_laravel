...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        body { font-family: Arial, sans-serif; background: #faf9f6; color: #2b2b2b; margin: 0; display: flex; min-height: 100vh; }
        ...
        h1 { font-family: 'Georgia', serif; font-weight: 400; font-size: 30px; letter-spacing: 1px; margin: 0 0 36px; color: #a9762f; }
        ...
        .cat-image { width: 100%; height: 180px; overflow: hidden; }
        .cat-image img { width: 100%; height: 100%; object-fit: cover; display: block; }

        .cat-body { padding: 15px; font-family: Arial, sans-serif; flex: 1; }
        .cat-body h3 { font-family: 'Georgia', serif; font-weight: 400; font-size: 18px; color: #1f1f1f; margin: 0 0 5px; }
        .cat-body .count { font-size: 13px; color: #8a8676; }

        .empty-msg { font-family: Arial, sans-serif; text-align: center; color: #9b968a; padding: 60px 0; }
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}">
                            <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="7" r="4"/><path d="M2 21c0-4 3-6 7-6s7 2 7 6"/><path d="M19 8v6M22 11h-6"/></svg>
