        ...
        <form action="{{ route('watches.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-[22px]">
                ...
                <textarea name="description" rows="4"
                    class="w-full py-2.5 px-3 border border-[#e7e3da] rounded bg-white text-[#2b2b2b] text-[13px] outline-none transition-colors focus:border-[#a9762f] resize-y min-h-[100px]">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="mb-[22px]">
                <label class="block mb-2 text-[13px] font-bold text-[#6b6355]">Image</label>
